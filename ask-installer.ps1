...
$url = "https://github.com/Pjdur/ask/releases/download/v2.0.0/ask-windows-x64.exe"
...
if ($currentPath -split ";" -notcontains $installDir) {
    ...
    Write-Host "PATH updated successfully. Restart terminal to use ask." -ForegroundColor Gray
} else {
